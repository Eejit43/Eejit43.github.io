...
fetch('https://ipgeolocation.abstractapi.com/v1/?api_key=7dcea861f91a44579cea73ad833eff21')
    ...
    .then((data) => {
        document.getElementById('ip-address').innerHTML = `${data.ip_address} (${data.security.is_vpn ? 'Is' : 'Not'} a <span class="tooltip-text tooltip-bottom" data-tooltip="Virtual private network">VPN</span><sup class="tooltip-text tooltip-top" style="text-decoration: none" data-tooltip="May not be accurate">*</sup>)`; // prettier-ignore
