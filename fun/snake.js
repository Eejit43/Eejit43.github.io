    ...
    */
    ...
    return function (inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmPauseScreen.innerHTML = "<div style='padding:10px;'>Game Paused<p/>Press [space] to unpause.</div>";
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "Snake Game<p></p>Use the <strong>arrow keys</strong> on your keyboard to play the game. Press the space bar to pause/unpause the game." + "<p></p>";
        ...
        function createGameEndElement(message, elmId, elmClassName) {
            ...
            gameEndTxt.innerHTML = "Snake Game<p></p>" + message + "<p></p>";
